...
- [docs/visual_guide.md](docs/visual_guide.md): original schematic figures and synthetic plots for teaching.
...
- [figures/](figures): SVG figures generated by [scripts/generate_figures.py](scripts/generate_figures.py).
